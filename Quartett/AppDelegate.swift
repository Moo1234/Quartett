...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        saveAttribute(6, cardset: 1, name: "PAC", icon: "0auf100", unit: "", condition: true)
        saveAttribute(7, cardset: 1, name: "DRI", icon: "hubraum", unit: "", condition: true)
        saveAttribute(8, cardset: 1, name: "SHO", icon: "PS", unit: "", condition: true)
        saveAttribute(9, cardset: 1, name: "DEF", icon: "speed", unit: "", condition: true)
        saveAttribute(10, cardset: 1, name: "PAS", icon: "umdrehung", unit: "", condition: true)
        saveAttribute(11, cardset: 1, name: "PHY", icon: "zylinder", unit: "", condition: true)
