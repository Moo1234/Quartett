...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        saveCard(17, cardset: 2, name: "Ibrahimovic", info: "Zlatan Ibrahimović (* 3. Oktober 1981 in Malmö)[1] ist ein schwedisch-bosnischer[2][3] Fußballspieler, der beim französischen Erstligisten Paris Saint-Germain unter Vertrag steht. Als erster und einziger Spieler wurde der Stürmer zehnmal mit dem Guldbollen als schwedischer Fußballer des Jahres ausgezeichnet, davon neunmal in Folge. Er gilt als einer der besten Stürmer der Welt und besticht insbesondere durch seine starke Technik und seine spektakulären Spielaktionen", image: "ibrahimovic", values: "73,81,90,85,31,86")
        ...
        saveCard(22, cardset: 2, name: "Rodriguez", info: "James David Rodríguez Rubio (* 12. Juli 1991 in Cúcuta), kurz James Rodríguez [ˈxames roˈðɾiɣes] oder James [ˈxames], ist ein kolumbianischer Fußballspieler, der seit Sommer 2014 bei Real Madrid unter Vertrag steht.", image: "rodriguez", values: "78,84,86,85,40,72")
        ...
        saveCard(26, cardset: 2, name: "Modric", info: "Luka Modrić [ˈluːka ˈmɔːdritɕ] (* 9. September 1985 in Zadar, SR Kroatien, SFR Jugoslawien) ist ein kroatischer Fußballspieler. Seit 2012 steht er bei Real Madrid unter Vertrag.", image: "modric", values: "76,84,74,89,71,68")
        saveCard(27, cardset: 2, name: "Özil", info: "Mesut Özil türkisch,[Mesut özil] [ˈmesut ˈœzil] (* 15. Oktober 1988 in Gelsenkirchen) ist ein deutscher Fußballspieler. Seit September 2013 steht er beim FC Arsenal unter Vertrag. 2014 wurde er mit der deutschen Nationalmannschaft in Brasilien Weltmeister.", image: "ozil", values: "72,85,74,86,24,57")
